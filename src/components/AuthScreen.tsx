        ...
        <div className="p-6">
          {tab === 'login' ? (
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              {/* Demo switch accounts for quick review */}
              <div className="pt-3 border-t border-slate-800">
                <p className="text-[11px] text-slate-400 mb-2 font-medium">Quick demo sign-in accounts:</p>
                <div className="flex gap-2">
                  ...
                  >
                    ...
                    <div className="text-[9px] text-emerald-400">Investor</div>
                  </button>
                  <button
                    type="button"
