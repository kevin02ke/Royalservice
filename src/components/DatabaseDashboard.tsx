...
export const DatabaseDashboard: React.FC = () => {
  ...
  const tableCards = [
    ...
    },
    {
      ...
      desc: 'Binance Pay USDT & M-Pesa B2C cashout queues',
      icon: ArrowUpRight,
    ...
    },
    {
      ...
      count: dbStatus?.counts.chatThreads ?? 3,
    ...
    },
    {
      ...
      name: 'chat_messages',
      label: 'Support Logs',
      count: dbStatus?.counts.chatMessages ?? 7,
    ...
    },
    {
      ...
      count: 1,
      desc: 'Fees (M-Pesa 10%, Binance 5%), minimum limits & rates',
      icon: Sliders,
      ...
      <div className="bg-gradient-to-r from-purple-950/40 via-indigo-950/30 to-[#0d1320] border border-purple-500/30 rounded-2xl p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="space-y-1">
          ...
          <div className="flex flex-wrap gap-2 pt-1">
            ...
            <span className="px-2 py-0.5 rounded bg-yellow-500/10 text-yellow-300 text-[11px] font-mono border border-yellow-500/30">
              Binance Pay API (Automated USDT Webhook)
            </span>
