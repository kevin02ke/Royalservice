          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full p-6 border border-slate-200">
            ...
            <div className="py-4 space-y-3.5 text-xs text-slate-600 leading-relaxed max-h-[60vh] overflow-y-auto">
              ...
              <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                ...
                <p>
                  While Binance crypto rails support automated API settlement, mobile money disbursements (M-Pesa B2C) are subject to batch liquidity reconciliations and compliance verifications, typically processed within 6 hours.
                </p>
              </div>
            </div>
