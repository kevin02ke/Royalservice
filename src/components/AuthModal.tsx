...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  const handleQuickDemoSwitch = (email: string) => {
      ...
      >
          ...
          {tab === 'login' ? (
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="pt-3 border-t border-slate-800">
                <p className="text-[11px] text-slate-400 mb-2 font-medium">Quick switch demo investor:</p>
                <div className="flex gap-2">
                  <button
                    type="button"
                    onClick={() => handleQuickDemoSwitch('j.wanjiku@investor.ke')}
                  ...
                  >
                    ...
                    <div className="text-[9px] text-emerald-400">KES 1,450 Bal</div>
                  </button>
                  <button
                    type="button"
                    onClick={() => handleQuickDemoSwitch('ken.omondi@gmail.com')}
                    className="flex-1 py-1.5 px-2 bg-slate-800/80 hover:bg-slate-700 border border-slate-700/60 rounded-lg text-[10px] text-slate-300 font-medium transition text-left"
                  >
                    <div className="font-bold text-white">Kennedy Omondi</div>
                    <div className="text-[9px] text-emerald-400">KES 4,200 Bal</div>
                  </button>
                </div>
              </div>
            </form>
        ...
        <div className="px-5 py-3 bg-[#080d17] border-t border-slate-800/80 flex items-center justify-between text-[10px] text-slate-400">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className={`w-2 h-2 rounded-full ${neonStatus?.isNeonConnected ? 'bg-emerald-400 shadow-[0_0_6px_rgba(52,211,153,0.8)]' : 'bg-emerald-500'}`} />
          </div>
        </div>
      </motion.div>
    </div>
